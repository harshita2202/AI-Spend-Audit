          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="px-6 py-5 space-y-6">
                ...
                <Button
                  onClick={() => setStep(2)}
                  className="w-full rounded-sm font-semibold gap-2"
                >
