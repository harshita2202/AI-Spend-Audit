...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-fg leading-relaxed mb-7 max-w-md">
                A free 2-minute audit that tells you exactly where your team is over-provisioned — and what to do about it.
              </p>
              <Link
                href="/audit"
            ...
            <div className="relative">
              ...
              <div className="relative bg-card rounded-sm border border-border overflow-hidden shadow-lg">
                ...
                <div className="bg-muted px-4 py-2.5 border-b border-border flex items-center gap-2">
                  ...
                  <span className="text-xs text-muted-fg mx-auto font-mono-app">spendsense.ai — audit results</span>
                </div>
                {/* Savings banner */}
                <div className="bg-green-50 border-b border-green-100 px-4 py-3 flex items-center justify-between">
                  <span className="text-green-700 text-xs font-bold uppercase tracking-widest font-mono-app">Monthly savings found</span>
                ...
                <div className="divide-y divide-border/60">
                  {PREVIEW_ROWS.map((row) => (
                    <div
                      ...
                      style={{
                        borderLeft: `3px solid ${row.status === "over" ? "#ef4444" : row.status === "opt" ? "#f59e0b" : "#22c55e"}`,
                      }}
                    >
      ...
      <section className="py-20 px-5 bg-background">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-foreground font-display">Three steps. Under two minutes.</h2>
          </div>
            ...
            {STEPS.map((s) => (
              <div key={s.step} className="bg-card border border-border rounded-sm p-6 hard-shadow">
                <div className="flex items-start justify-between mb-5">
                  ...
                  <span className="text-4xl font-black select-none font-display" style={{ color: "#e0ddf5" }}>{s.step}</span>
                </div>
      ...
      {/* ── Final CTA ── */}
      <section className="py-20 px-5 border-t border-border" style={{ background: "linear-gradient(160deg, #f0eaff 0%, #f8f7ff 100%)" }}>
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-4 font-display">Ready to see your number?</h2>
      ...
      <footer className="border-t border-border py-6 px-5">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-muted-fg">Powered by <span className="font-bold text-foreground">Credex</span></p>
